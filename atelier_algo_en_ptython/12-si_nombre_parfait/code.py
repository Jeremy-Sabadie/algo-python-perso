...
if condition:
  ...
  print("_le produit ainsi que la somme des diviseurs de "+str(nb)+" sont éguaux à : "+str(sum(array))+" .")
  print("_les diviseurs de "+str(nb)+" sont: "+str(array)
+" .")
elif condition==False:
  if prod!=nb:
    
    print("le produit des diviseurs de"+str(nb)+" n'est pas égal à: "+str(nb)+" mais est égal à : "+str(prod)
+" .")
  elif sumArray!=nb:
    print("_ la somme  des diviseurs de "+str(nb)+" n'est pas égal à:  "+str(nb)+" mais est égal à: "+str(sum(array))
+" .")
